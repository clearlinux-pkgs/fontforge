...
Patch1: 0001-Fixup-translation-problems.patch
...
%prep
%setup -q -n fontforge-20230101
cd %{_builddir}/fontforge-20230101
%patch -P 1 -p1
pushd ..
cp -a fontforge-20230101 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730179719
mkdir -p clr-build
pushd clr-build
...
export GOAMD64=v2
%cmake .. -DENABLE_LIBUNINAMESLIST=OFF  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfontforge.so.4
