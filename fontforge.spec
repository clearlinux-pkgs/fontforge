...
%prep
%setup -q -n fontforge-20170731
cd ..
%setup -q -T -D -n fontforge-20170731 -b 1
cd ..
%setup -q -T -D -n fontforge-20170731 -b 3
cd ..
%setup -q -T -D -n fontforge-20170731 -b 2
mkdir -p gnulib
mv %{_topdir}/BUILD/gnulib-0.1/* %{_topdir}/BUILD/fontforge-20170731/gnulib
mkdir -p uthash
mv %{_topdir}/BUILD/uthash-2.0.2/* %{_topdir}/BUILD/fontforge-20170731/uthash
mkdir -p debugfonts
mv %{_topdir}/BUILD/debugfonts-86de4778c730a2a3d7c42bb588ba5132663ffd2d/* %{_topdir}/BUILD/fontforge-20170731/debugfonts
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libfontforge.so.2
/usr/lib64/libfontforge.so.2.0.0
/usr/lib64/libfontforgeexe.so.2
/usr/lib64/libfontforgeexe.so.2.0.0
/usr/lib64/libgdraw.so.5
/usr/lib64/libgdraw.so.5.0.0
/usr/lib64/libgioftp.so.2
/usr/lib64/libgioftp.so.2.0.0
/usr/lib64/libgunicode.so.4
/usr/lib64/libgunicode.so.4.0.0
/usr/lib64/libgutils.so.2
