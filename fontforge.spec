...
%prep
%setup -q -n fontforge-20190413
cd ..
%setup -q -T -D -n fontforge-20190413 -b 1
cd ..
%setup -q -T -D -n fontforge-20190413 -b 3
cd ..
%setup -q -T -D -n fontforge-20190413 -b 2
mkdir -p gnulib
cp -r %{_topdir}/BUILD/gnulib-0.1/* %{_topdir}/BUILD/fontforge-20190413/gnulib
mkdir -p uthash
cp -r %{_topdir}/BUILD/uthash-2.0.2/* %{_topdir}/BUILD/fontforge-20190413/uthash
mkdir -p debugfonts
cp -r %{_topdir}/BUILD/debugfonts-86de4778c730a2a3d7c42bb588ba5132663ffd2d/* %{_topdir}/BUILD/fontforge-20190413/debugfonts
...
export LANG=C
export SOURCE_DATE_EPOCH=1555298314
